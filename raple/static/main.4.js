(this.wordle = this.wordle || {}),
    (this.wordle.bundle = (function (e) {
        ...
        function n(e, a, s) {
            return (
                a in e
                    ? Object.defineProperty(e, a, { value: s, enumerable: !0, configurable: !0, writable: !0 })
                    : (e[a] = s),
                e
            );
        }
                ...
                o(t, [
                    {
                        ...
                        value: function () {
                            ...
                            this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                                ...
                                (this.shadowRoot.querySelector("#puzzle-number").textContent = "#".concat(
        ...
        var Ea,
            Aa = (function (e) {
                ...
                function t() {
                    var e;
                    return (
                        s(this, t), n(p((e = a.call(this))), "_duration", void 0), e.attachShadow({ mode: "open" }), e
                    );
                }
                return (
                    o(t, [
        ...
        var Lac = "tuhan|roots|santi|güneş|keysi|hidra|kanye|piton|majik|kayra|raple|ayben|gunna|vatan|orkun|yasin|sakem|kerim|dianz|donda|bitap|pikap|emcee|velet|manga|argub|başar|khont|ashoo|evren|homie|snoop|buura|decoy|efsun|infaz|hakan|zenci|muşta|evrim|dilla|break|outro|drill|efyuu|yener|marka|kamuf|aksan|tolky|nadas|mirza|lider|kaset|firar|pusat|peace|skrrt|turbo|drake|smoke|saygı|joker|cegıd|pusha|sahto|ohash|yunus|ezhel|killa|vurgu|sokak|kazem|sinci|dance|fredd|serin|hayki|rasta|itaat|kılıç|ıntro|canka|kodes|aesop|lirik|nomad|kezzo|eypio|garez|sirmc|ender|yenik|facia|shure|unkle|murda|şeyho|saian|rakim|faroz|fader|sansi|dokuz|kasva|dirty|lamar|müzik|çağrı|mirac|tepki|bomba|bloke|susma|ramiz|fünye|sorgu|starz|casus|segah|hazel|zeval|punch|şüphe|timur|snare|burry|verse|cakal|rhyme|logic|despo|gucci|tupac|önder|tetik|playa|derya|isyan|fuchs|mesaj|amcas|scott|mlisa|grogi|pango|poizi";
            La = unescape(Lac).split("|"),
            Ta = [
                "aesop",
                "aksan",
                "amcas",
                            ...
                            value: function () {
                                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                                    ...
                                    if (((e = s), !Ta.includes(e) && !La.includes(e)))
                                        return (
                                            a.setAttribute("invalid", ""), void this.addToast("Kelime listesinde yok")
                                        );
                                    if (this.hardMode) {
                            ...
                            value: function () {
                                ...
                                this.$game.addEventListener("game-key-press", function (a) {
                                    ...
                                    "←" === s || "Backspace" === s
                                        ...
                                        : "↵" === s || "Enter" === s
                                          ? e.submitGuess()
                                          : Ba.includes(s.toLowerCase()) && e.addLetter(s.toLocaleLowerCase());
                                }),
                                        ...
                                        s.classList.add("row"),
                                            a.forEach(function (e) {
                                                ...
                                                if (
                                                    ...
                                                    (a = ls.content.cloneNode(!0).firstElementChild).classList.add(
                                                        1 === e.length ? "half" : "one"
                                                    );
                                                s.appendChild(a);
                                            }),
                    ...
                    o(t, [
                        {
                            ...
                            value: function () {
                                ...
                                if (
                                    (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach(
                                        function (s) {
                                            var t = Ms[s],
                                                o = e.stats[s],
