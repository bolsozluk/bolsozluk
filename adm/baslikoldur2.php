...
$sorgu = "UPDATE konular SET statu = 'silindi' WHERE id='$id'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET silmod = '$kullaniciAdi' WHERE id='$id'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET siltarih = '$gun/$ay/$yil $saat' WHERE id='$id'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET silsebep = '$sebep' WHERE id='$id'";
mysql_query($sorgu);
...
$sorgu = "UPDATE mesajlar SET statu = 'silindi' WHERE sira = '$id'";
mysql_query($sorgu);
