...
$sorgu = "UPDATE konular SET tarih='$tarih' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET gun='$gun' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET ay='$ay' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET yil='$ay' WHERE id='$canlandir'";
mysql_query($sorgu);

$sorgu = "UPDATE konular SET statu = '' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET silmod = '' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET siltarih = '' WHERE id='$canlandir'";
mysql_query($sorgu);
$sorgu = "UPDATE konular SET silsebep = '' WHERE id='$canlandir'";
mysql_query($sorgu);

$sorgu = "UPDATE mesajlar SET statu = '' WHERE sira = '$canlandir'";
mysql_query($sorgu);
...
$sor = mysql_query("SELECT id FROM konular WHERE statu = 'silindi' ORDER BY `tarih`");
...
<table width=\"685\" border=\"1\" cellpadding=\"0\" cellspacing=\"1\" bordercolor=\"#669999\">
  <tr>
    ...
    <td width=\"369\"><div align=\"center\"><strong>BASLIK</strong></div></td>
    <td width=\"192\"><div align=\"center\"><strong>MOD/ADMIN</strong></div></td>
  </tr>

  ";
$sorgu = "SELECT id,silsebep,siltarih,silmod,tarih,gun,ay,yil,baslik FROM konular WHERE statu = 'silindi' ORDER BY `tarih` desc limit $alt,$max";
