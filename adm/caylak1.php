...
<?
$cay1sebep= guvenlikKontrol($_REQUEST["cay1sebep"],"hard");
...
if ($cay1sebep == "") { echo "Çaylaklık sebebi girmediniz.";}
...
$muddettarih = ($tarih + $muddet);
	...
	$sorgu4 = "UPDATE user SET muddet='1' WHERE nick='$eskinick'";
	mysql_query($sorgu4);
...
/*
		...
		$saat = date("H:i");
			...
			$mesaj = "`$eskinick` yönetim tarafından \"$cay1sebep\" sebebiyle 1 gün süreyle çaylak edilmiştir. (sorumlu: $kullaniciAdi)";
