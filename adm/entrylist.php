...
echo "<strong>$userNickName nickine ait son 100 entry asagida listelendi.</strong><br><br>";
$sorgu = "SELECT id,sira,mesaj,yazar,tarih FROM mesajlar WHERE yazar = '$userNickName' ORDER by `id` desc LIMIT 0,100";
...
echo "Bu mal hic entry girmemis daha.";
}
