...
$dMon = $cMon - 1;
$eMon = $cMon - 2;
$sorgu = "SELECT id FROM mesajlar WHERE ay='$eMon' and yil ='2020' ORDER by id desc ";
$sorgulama = mysql_query($sorgu);
$kayit=mysql_fetch_array($sorgulama);
$g2entry=$kayit["id"];
//echo $g2entry;
$sorgu = "SELECT id FROM mesajlar WHERE ay='$dMon' and yil ='2020' ORDER by id desc ";
$sorgulama = mysql_query($sorgu);
$kayit=mysql_fetch_array($sorgulama);
$g1entry=$kayit["id"];
//echo $g1entry;
...
$g3entry=$kayit["id"];
//echo $g3entry;
$sorgu = "SELECT id FROM mesajlar WHERE ay='$cMon' and yil ='2020' ORDER by id desc ";
$sorgulama = mysql_query($sorgu);
$kayit=mysql_fetch_array($sorgulama);
$g4entry=$kayit["id"];
//echo $g4entry;
...
$ikiyazq = mysql_query("select id from user WHERE durum = 'on' AND id>=1419");
...
$listele2 = mysql_query("SELECT yazar, COUNT(*) as adet FROM mesajlar WHERE statu !='silindi' AND yazar !='uim'  GROUP BY yazar ORDER BY adet DESC LIMIT 0,19");
...
$eniyibaslik99=mysql_fetch_array(mysql_query("SELECT baslik from konular where id='$sira9'"));
$eniyibaslik9 = $eniyibaslik99["baslik"];
mysql_query("UPDATE debe SET hebeb9 = '$eniyibaslik99'");
