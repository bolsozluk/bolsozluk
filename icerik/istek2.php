...
$sorgu = "SELECT id,sira,mesaj,yazar,tarih,statu,istekhatti FROM mesajlar WHERE (statu != 'silindi' and statu!='wait' and sira = '120' and istekhatti = '3') ORDER by `id` desc LIMIT 0,5000";  
echo "<strong>işlem bekleyen talepler.</strong><br><br>";
...
<table width=\"700\" height=\"77\" border=\"1\">
  <tr>
    ...
    {
    	echo  "<td width=\"534\"><strong>durum</strong></td>";
    }
    echo "
  </tr>
";
...
echo "
  <tr>
    ...
    if ($kulYetki == "admin" or $kulyetki == "mod")
    {
    	echo  "<td><font size=1><i><a href=?process=adm&islem=istek&bid=$id&a=1 target=new>[çözüldü] </a></i>
    	<font size=1><i><a href=?process=adm&islem=istek&bid=$id&a=2 target=new>[reddedildi] </a></i>
    	    	<font size=1><i><a href=?process=adm&islem=istek&bid=$id&a=4 target=new>[boşa]</a></i>
