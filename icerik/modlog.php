...
$sorgu = "SELECT id,mesaj,yazar,ip,siltarih,silsebep,silen,statu,sira FROM mesajlar WHERE statu ='silindi' and siltarih != '' and silsebep != ''  ORDER by `siltarih` desc LIMIT 0,750"; //and (silen ='admin' or silen ='') 
...
echo "
<table width=\"100%\" height=\"77\" border=\"1\">
  <tr>
    <td width=\"17%\"><strong>işlemi yapan</strong></td>
    <td width=\"17%\"><strong>işlem yapılan</strong></td>
    <td width=\"14%\"><strong>işlem</strong></td>
    <td width=\"20%\"><strong>işlem sebebi</strong></td>
    <td width=\"20%\"><strong>başlık adı</strong></td>
    <td width=\"12%\"><strong>entry no</strong></td>
  </tr>
";
...
<table width=\"700\" height=\"77\" border=\"1\">
  <tr>
    ...
    <td width=\"534\"><strong>başlık adı</strong></td>
    <td width=\"534\"><strong>entry no</strong></td>
  </tr>
";
...
$sorgu1 = "SELECT baslik FROM konular WHERE id ='$basliks'";
$sorgu2= @mysql_query($sorgu1);
//mysql_num_rows($sorgu2);
$baslik2=@mysql_fetch_array($sorgu2);
